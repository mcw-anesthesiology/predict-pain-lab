...
"use strict";
/* harmony export (immutable) */ exports["b"] = isInView;
/* harmony export (immutable) */ exports["a"] = getPageData;
var headerHeight = document.querySelector('.site-header').clientHeight;

function isInView(element) {
	var rect = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : element.getBoundingClientRect();

	return rect.bottom > headerHeight && rect.top < window.innerHeight && rect.right > 0 && rect.left < window.innerWidth;
}
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(exports, "d", function() { return PRIMARY_COLOR; });
/* harmony export (binding) */ __webpack_require__.d(exports, "b", function() { return ACCENT_COLOR; });
/* unused harmony export PRIMARY_TEXT */
/* harmony export (binding) */ __webpack_require__.d(exports, "c", function() { return SECONDARY_TEXT; });
/* unused harmony export DISABLED_TEXT */
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return BREAKPOINTS; });
var PRIMARY_COLOR = '#2a7ae2';
var ACCENT_COLOR = '#ff3d2e';

var PRIMARY_TEXT = 0.87;
var SECONDARY_TEXT = 0.54;
var DISABLED_TEXT = 0.38;

var BREAKPOINTS = {
	EXTRA_SMALL_SCREEN: 350,
	SMALL_DESKTOP: 768,
	MEDIUM_DESKTOP: 992,
	LARGE_DESKTOP: 1200
};
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(116).Buffer, __webpack_require__(48)))
...
/* MIT license */
var cssKeywords = __webpack_require__(118);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_js__ = __webpack_require__(178);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__parallax_js__ = __webpack_require__(183);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__parallax_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__parallax_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__acronym_js__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__acronym_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__acronym_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__choose_mke_js__ = __webpack_require__(177);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__choose_mke_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__choose_mke_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__element_in_view_js__ = __webpack_require__(180);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__element_in_view_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__element_in_view_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__home_js__ = __webpack_require__(181);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__home_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__home_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__people_js__ = __webpack_require__(184);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__people_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__people_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__research_map_js__ = __webpack_require__(185);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__research_map_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__research_map_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__sticky_js__ = __webpack_require__(186);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__sticky_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__sticky_js__);
...
__webpack_require__(467).polyfill()
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_js__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__constants_js__ = __webpack_require__(80);




var letters = ['p', 'r', 'e', 'd', 'i', 'c', 't'];
var acronym = document.querySelector('.predict-acronym');
var transitionDurationSeconds = 0.2;
var delayOffsetSeconds = 0.4;
var smallTransitionDurationSeconds = 1;
var letterElements = {};

if (acronym && __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_js__["b" /* isInView */])(acronym)) {
...
function moveTermLetters() {
	...
	try {
		for (var _iterator = letters[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
			...
			var termLetter = acronym.querySelector('h1 .' + letter);
			var definitionLetter = acronym.querySelector('figcaption .' + letter);
			...
			var termStyle = window.getComputedStyle(termLetter);
			var definitionStyle = window.getComputedStyle(definitionLetter);
			var scale = parseInt(definitionStyle.getPropertyValue('font-size'), 10) / parseInt(termStyle.getPropertyValue('font-size'), 10);
			var definitionLetterString = definitionLetter.textContent.charAt(0);
			...
			var termRect = termLetter.getBoundingClientRect();
			var definitionRect = definitionLetter.getBoundingClientRect();
			var translate = {
			...
			var definitionLetterColor = new __WEBPACK_IMPORTED_MODULE_0_color___default.a(__WEBPACK_IMPORTED_MODULE_2__constants_js__["b" /* ACCENT_COLOR */]);
			definitionLetterColor.alpha(__WEBPACK_IMPORTED_MODULE_2__constants_js__["c" /* SECONDARY_TEXT */]);
			...
			letterElements[letter] = {
				...
				definitionLetter: definitionLetter
			};
		}
	} catch (err) {
...
function moveTermLettersBack() {
	...
	try {
		var _loop = function _loop() {
			...
			var termLetter = letterElements[letter].termLetter;
			var definitionLetter = letterElements[letter].definitionLetter;
	...
	var small = acronym.querySelector('h1 small');
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_flickity__ = __webpack_require__(381);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_flickity_dist_flickity_css__ = __webpack_require__(471);
...
var carousel = document.querySelector('#choose-mke-attractions');
...
if (carousel) {
	(function () {
		...
		var slideLinks = Array.from(document.getElementsByClassName('slick-slide-link'));
		var _iteratorNormalCompletion = true;
		var _didIteratorError = false;
		var _iteratorError = undefined;

		try {
			for (var _iterator = slideLinks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
				var slideLink = _step.value;
...
window.initMap = function () {
	...
	var map = new google.maps.Map(document.getElementById('milwaukee-map'), {
		center: {
			lat: 43.0429319,
			lng: -87.9709897
		},
		...
		styles: [{
			...
			'elementType': 'all',
			'stylers': [{
				'color': __WEBPACK_IMPORTED_MODULE_2__constants_js__["d" /* PRIMARY_COLOR */]
			}, {
				'visibility': 'on'
			}]
		}]
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__page_nav_js__ = __webpack_require__(182);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__page_nav_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__page_nav_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__constants_js__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_debounce__ = __webpack_require__(49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_velocity_animate__ = __webpack_require__(473);
...
window.addEventListener('resize', __WEBPACK_IMPORTED_MODULE_2_lodash_debounce___default()(fixHeader, 100));

function fixHeader() {
	headerHeight = header.clientHeight;
	main.style.setProperty('padding-top', headerHeight + 'px');
	if (hero) {
		if (window.innerWidth < __WEBPACK_IMPORTED_MODULE_1__constants_js__["a" /* BREAKPOINTS */].SMALL_DESKTOP) {
...
var scrollToContent = document.querySelector('.scroll-to-content');
if (scrollToContent) {
	scrollToContent.addEventListener('click', function () {
		__WEBPACK_IMPORTED_MODULE_3_velocity_animate___default()(hero, 'scroll', { offset: hero.clientHeight - headerHeight });
	});
}

var internalLinks = Array.from(document.getElementsByClassName('internal-link'));
var _iteratorNormalCompletion = true;
var _didIteratorError = false;
var _iteratorError = undefined;
	...
	for (var _iterator = internalLinks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
		...
		link.addEventListener('click', function (event) {
			...
			if (target.charAt(0) === "#") {
				...
				__WEBPACK_IMPORTED_MODULE_3_velocity_animate___default()(targetElement, 'scroll', { offset: headerHeight * -1, complete: function complete() {
...
var expandSectionElements = Array.from(document.querySelectorAll('.expand-section-element'));
var _iteratorNormalCompletion2 = true;
var _didIteratorError2 = false;
var _iteratorError2 = undefined;
	...
	var _loop = function _loop() {
		...
		element.addEventListener('click', function (event) {
			...
			if (targetElement.classList.contains('collapsed')) {
				...
				__WEBPACK_IMPORTED_MODULE_3_velocity_animate___default()(targetElement, 'slideDown', function () {
					element.textContent = element.textContent.replace('Show', 'Hide').replace('show', 'hide');
				});
			} else {
				__WEBPACK_IMPORTED_MODULE_3_velocity_animate___default()(targetElement, 'slideUp', function () {
...
var ignoredAnchors = Array.from(document.querySelectorAll('.ignore-click'));
var _iteratorNormalCompletion3 = true;
var _didIteratorError3 = false;
var _iteratorError3 = undefined;

try {
	for (var _iterator3 = ignoredAnchors[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_preact__ = __webpack_require__(164);
...
var PersonDetails = function (_Component) {
	_inherits(PersonDetails, _Component);

	function PersonDetails() {
		_classCallCheck(this, PersonDetails);

		return _possibleConstructorReturn(this, (PersonDetails.__proto__ || Object.getPrototypeOf(PersonDetails)).apply(this, arguments));
	}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_js__ = __webpack_require__(57);


var currentElement = document.querySelector('.in-view');
...
function viewStep() {
	...
	for (var i = 0; i < watchedElements.length; i++) {
		var element = watchedElements[i];
		if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_js__["b" /* isInView */])(element)) elementsInView.push(element);
	}

	if (elementsInView.length === 0) return;
	...
	try {
		for (var _iterator = elementsInView[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
			var _element = _step.value;

			var amountInView = getAmountInView(_element);
	...
	if (newElement !== currentElement) {
		if (currentElement) {
			...
			var _id = currentElement.dataset.id;
			if (_id === '#') _id = '';
			var _link = document.querySelector('a.page-link[href="#' + _id + '"]');
			if (_link) _link.classList.remove('active');
		}

		newElement.classList.add('in-view');
		var id = newElement.dataset.id;
		if (id === '#') id = '';
		var link = document.querySelector('a.page-link[href="#' + id + '"]');
		if (link) {
			link.classList.add('active');
			var href = id ? '#' + id : window.location.pathname + window.location.search;
...
var page = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_js__["a" /* getPageData */])();

if (page.create_page_nav) {
	var pageNav = document.querySelector(".page-nav");
	var headings = Array.from(document.querySelectorAll(".page-content h2"));
	var _iteratorNormalCompletion = true;
	var _didIteratorError = false;
	var _iteratorError = undefined;
...
var header = document.querySelector('.site-header');
var containers = Array.from(document.querySelectorAll('.parallax-container'));
var headerHeight = void 0;
var innerHeight = void 0;
var previousScroll = void 0;
var parallaxes = void 0;
...
function getParallaxes() {
	...
	parallaxes = containers.map(function (container) {
...
function updateParallaxes() {
	...
	try {
		for (var _iterator = parallaxes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
			...
			parallax.inView = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_js__["b" /* isInView */])(parallax.container, parallax.containerRect);
			if (parallax.inView) {
				var parallaxRect = {
				...
				if (parallax.containerRect.top >= parallaxRect.top && parallax.containerRect.top <= parallaxRect.bottom) {
					var scrolledValue = (parallaxRect.bottom - parallax.containerRect.top) / parallaxRect.height;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_preact__ = __webpack_require__(164);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_preact___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_preact__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_PersonDetails_js__ = __webpack_require__(179);
...
peopleLinks.map(function (personLink) {
	personLink.addEventListener('click', function (event) {
		...
		var details = personLink.dataset.details;
		__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["render"])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_1__components_PersonDetails_js__["a" /* default */], details), document.querySelector('#person-details'));
	});
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_debounce__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_debounce___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash_debounce__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_research_partners_yaml__ = __webpack_require__(389);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_research_partners_yaml___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__data_research_partners_yaml__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__includes_svgs_star_svg__ = __webpack_require__(468);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__includes_svgs_star_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__includes_svgs_star_svg__);
...
if (map) {
	...
	try {
		var _loop = function _loop() {
			...
			starContainer.insertAdjacentHTML('beforeend', '<a href="' + partner.url + '" class="map-star notransition"\n\t\tdata-partner-name="' + partner.name + '" rel="external"\n\t\ttitle="View partner website">' + __WEBPACK_IMPORTED_MODULE_2__includes_svgs_star_svg___default.a + '</a>');
			var stars = starContainer.querySelectorAll('.map-star');
			var newStar = stars[stars.length - 1];
		...
		for (var _iterator = __WEBPACK_IMPORTED_MODULE_1__data_research_partners_yaml___default.a[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
			_loop();
		}
	} catch (err) {
		_didIteratorError = true;
	...
	window.addEventListener('resize', __WEBPACK_IMPORTED_MODULE_0_lodash_debounce___default()(adjustPartnerCoordinates, 100));
...
function adjustPartnerCoordinates() {
	...
	try {
		for (var _iterator3 = __WEBPACK_IMPORTED_MODULE_1__data_research_partners_yaml___default.a[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
			var partner = _step3.value;

			var state = document.getElementById(partner.state);
			var _star = document.querySelector('.map-star[data-partner-name="' + partner.name + '"]');
			var starPos = convertStateCoordsToPixels(state, partner.coordinates.x, partner.coordinates.y);
			_star.style.left = starPos.x - mapContainerRect.left + 'px';
			_star.style.top = starPos.y - mapContainerRect.top + 'px';
		}
	} catch (err) {
		_didIteratorError3 = true;
		_iteratorError3 = err;
...
function stickSticky(element) {
	...
	if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_js__["b" /* isInView */])(parent)) return;
...
if(!(TO_PRIMITIVE in proto))__webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(196));
...
/* WEBPACK VAR INJECTION */(function(global) {var now = __webpack_require__(466)
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(48), __webpack_require__(165)))
