	...
	function updateParallaxes() {
		...
		try {
			for (var _iterator = parallaxes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
				...
				parallax.inView = (0, _utils.isInView)(parallax.container, parallax.containerRect);
				if (parallax.inView) {
					var parallaxRect = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function viewStep() {
		...
		for (var i = 0; i < watchedElements.length; i++) {
			...
			if ((0, _utils.isInView)(element)) elementsInView.push(element);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _research_partners = __webpack_require__(133);
	
	var _research_partners2 = _interopRequireDefault(_research_partners);
	
	var _star2 = __webpack_require__(134);
